...
class prm_Perm_Bibs_List extends WP_List_Table {
    ...
    function __construct($updated_ID= NULL,$event_ID=NULL){
        ...
        parent::__construct( array(
            'singular'  => 'bib',     //singular name of the listed records
            'plural'    => 'bibs',    //plural name of the listed records
    ...
    function extra_tablenav( $which ) {
       if ( $which == "top" ){
          //The code that goes before the table is here
           echo '<h2>Permanent Bib Management</h2>';
    ...
    function prepare_items() {
       ...
       $sql = 'select name,course_type, access, length, measurement_type from
