...
class prm_Crew_List extends WP_List_Table {
    ...
    function extra_tablenav( $which ) {
       if ( $which == "top" ){
          //The code that goes before the table is here
           ...
           echo('<a href="?page=prm-crew&m=m&o=crew&a=add&f=9l">Add new Crew Member</a>');
       }
       /*if ( $which == "bottom" ){
    ...
    function column_first_name($item){
        ...
        //Build row actions
        $actions = array(
            'View'      => sprintf('<a href="?page=%s&m=v&o=crew&a=%s&i=%s&f=9m">View</a>',$_REQUEST['page'],'view',$item->ID)
        );
    ...
    function prepare_items() {
       ...
       $sql = 'select * from '.$wpdb->prefix.'prm_crew';
